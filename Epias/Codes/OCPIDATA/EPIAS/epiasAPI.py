...
while(True):
    try:
        ...
        if(datetime4write.hour == 15 and datetime4write.minute == 0) or (datetime4write.hour == 23 and datetime4write.minute == 0):
            ...
            headersEpias = {
                "X-IBM-Client-Id": "69832eed-d22e-4818-a965-8f2ddfe1b3c2",
            ...
            piUrl4ptf = "https://10.13.63.234/piwebapi/streams/F1DP6UGiJEX5ckmZE5dg0JJyvgVAcAAAU1JWT0NQSURBVEFcMTFEQzAxX0VORVJHWV9FUElBU19HT1BfUFRG/value"
    ...
    #datetime4write.hour == 8 and datetime4write.minute == 0
        ...
        if(datetime4write.hour == 8 and datetime4write.minute == 0):
            ...
            piUrl4smf = "https://10.13.63.234/piwebapi/streams/F1DP6UGiJEX5ckmZE5dg0JJyvgUQcAAAU1JWT0NQSURBVEFcMTFEQzAxX0VORVJHWV9FUElBU19ER1BfU01G/value"
    ...
    #datetime4write.day == 20 and datetime4write.hour == 8 and datetime4write.minute == 0'''
        ...
        if(datetime4write.day == 20 and datetime4write.hour == 8 and datetime4write.minute == 0):
            ...
            piUrl4yekdem = "https://10.13.63.234/piwebapi/streams/F1DP6UGiJEX5ckmZE5dg0JJyvgUwcAAAU1JWT0NQSURBVEFcMTFEQzAxX0VORVJHWV9FUElBU19ZRUtERU0/value"
