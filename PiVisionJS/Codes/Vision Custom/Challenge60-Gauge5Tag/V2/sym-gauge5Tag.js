(function (PV) {
	...
	symbolVis.prototype.init = function (scope, elem){ 
        ...
        //axis.axisFill.fill = am4core.color("#FFFFFF");
        axis.renderer.labels.template.fill = am4core.color("#FFFFFF");
        //axis.renderer.labels.template.fontSize = 30;
        ...
        //hand.renderer.ticks.template.stroke = am4core.color("#FFFFFF");
        //hand.renderer.line.stroke = am4core.color("#FFFFFF");
        hand.fill = am4core.color("#FFFFFF");
        hand.stroke = am4core.color("#FFFFFF");
        //hand.renderer.labels.template.fill = am4core.color("#FFFFFF");
        ...
        function dataUpdate(newData){
            ...
            if(newData){
                    ...
                    var asdasd = "[bold #f00]takenvalue";
